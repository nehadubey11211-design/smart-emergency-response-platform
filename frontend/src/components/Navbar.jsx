 ...
 * It uses React Router's NavLink to highlight the active page, and includes a logout
 * button that clears auth data and redirects to login. The nav items are defined in
 * a data array for easy maintenance.
 *
 * In easy words:
